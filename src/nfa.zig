...
pub const State = struct {
    ...
    pub fn addTransition(self: *Self, allocator: std.mem.Allocator, transition: Transition) !void {
    ...
    pub fn addEpsTransition(self: *Self, allocator: std.mem.Allocator, dest_index: u32) !void {
